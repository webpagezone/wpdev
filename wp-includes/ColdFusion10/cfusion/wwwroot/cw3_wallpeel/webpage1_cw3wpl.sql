...
--
-- Host: localhost
-- Generation Time: Dec 25, 2018 at 03:15 PM
...
(1, 'General Admin', 'admin', 'admin', 'admin', '2018-12-22 18:16:06', '2018-08-18 08:01:06'),
(2, 'Super Admin', 'sa', 'admin', 'superadmin', '2006-11-26 07:05:53', '2006-11-19 09:49:42'),
(3, 'wallpeel', 'wallpeell', 'S@tmar00!', 'admin', '2018-08-03 23:18:10', '2002-01-01 01:00:00');
...
INSERT INTO `tbl_cart` (`cart_Line_ID`, `cart_custcart_ID`, `cart_sku_ID`, `cart_sku_qty`, `cart_dateadded`) VALUES
(1, '4097540', 30, 1, '2018-12-22 00:00:00');
...
(8, 3, 'CompanyName', 'Company Name', 'WallPeel', 'text', 'This is the name of the store, used on invoices and in email confirmations.', '', 1, 0, 1),
(9, 3, 'CompanyAddress1', 'Address 1', '2172 Gulf Gate drive', 'text', 'The first line of the company address', '', 1, 2, 1),
(10, 3, 'CompanyAddress2', 'Address 2', '', 'text', 'The second line of the company address (if necessary).', '', 1, 3, 1),
(11, 3, 'CompanyCity', 'City', 'Sarasota', 'text', 'The company''s city.', '', 1, 4, 1),
(12, 3, 'CompanyState', 'State / Prov', 'FL', 'text', 'The state or province the company is located in.', '', 1, 5, 1),
(13, 3, 'CompanyZip', 'Postal Code', '34231', 'text', 'The company''s postal or zip code.', '', 1, 6, 1),
(14, 3, 'CompanyCountry', 'Country', 'United States', 'text', 'The company''s country.', '', 1, 7, 1),
(15, 3, 'CompanyPhone', 'Phone', '941 706-3030', 'text', 'The company phone number.', '', 1, 8, 1),
(16, 3, 'CompanyFax', 'Fax', '', 'text', 'The company fax number.', '', 1, 9, 1),
(17, 3, 'CompanyEmail', 'Email', 'tundi0000@gmail.com', 'text', 'This is the company email. All automated emails are sent from this address, and order confirmations are sent to this address.', '', 1, 10, 1),
...
(32, 8, 'NumberOfColumns', 'Number of Columns', '3', 'text', 'The number of columns to be displayed on the product results page. Set this value to 1 to show the product short description and image. Set this value to any number greater than 1 to show only the product name and image in multiple columns.', '', 1, 0, 1),
(33, 8, 'ResultsPerPage', 'Results per Page', '6', 'text', 'This value should be evenly divisible by the Number of Columns in order to ensure correct display for multi-column results.', '', 1, 0, 1),
(34, 8, 'DetailsDisplay', 'Details Display', 'Simple', 'select', 'Determines how product option details are displayed.', 'Advanced|Advanced\r\nSimple|Simple\r\nTables|Tables', 1, 0, 1),
...
(53, 8, 'RelateCategoriesSecondaries', 'Relate Categories/Secondaries', 'True', 'boolean', 'Check the box if your categories and secondary categories are related. Relationships are handled at the product level.', 'NULL', 1, 0, 0),
...
CREATE TABLE IF NOT EXISTS `tbl_customers` (
  ...
  `cst_Username` varchar(100) DEFAULT NULL,
...
('4C8366EB-08-14-18', 1, 'Margaret', 'Gulya', '2172 Gulf Gate drive', '', 'Sarasota', '34231', 'Margaret Gulya', '2172 Gulf Gate drive', '', 'Sarasota', '34231', '9417063030', 'tundi0000@gmail.com', 'tundi0000', 'Jss4mc00'),
('5CF50A3D-12-22-18', 1, 'Margaret', 'Gulya', '5566 Bent Oak dr', '', 'Sarasota', '34232', 'Margaret Gulya', '5566 Bent Oak dr', '', 'Sarasota', '34232', '9417353228', 'buyer@wallpeel.com', 'info@gulfgatepackandship.com', 'Jss4mc00'),
...
(128, '4C8366EB-08-14-18', 1, 'BillTo'),
(129, '4C8366EB-08-14-18', 1, 'ShipTo'),
(130, '5CF50A3D-12-22-18', 9, 'BillTo'),
(131, '5CF50A3D-12-22-18', 9, 'ShipTo');
...
CREATE TABLE IF NOT EXISTS `tbl_list_optiontypes` (
  ...
  `optiontype_SortOrder` int(11) DEFAULT NULL,
  `optiontype_FileName` int(100) DEFAULT NULL COMMENT 'transparent image',
...
INSERT INTO `tbl_list_optiontypes` (`optiontype_ID`, `optiontype_Required`, `optiontype_Name`, `optiontype_SortOrder`, `optiontype_FileName`, `optiontype_Archive`) VALUES
(1, 1, 'Size', NULL, NULL, 0),
(2, 1, 'Color', NULL, NULL, 0),
(3, 1, 'Cut', NULL, NULL, 0),
(4, 1, 'Other', NULL, NULL, 0),
(5, 1, 'T-shirt Comfort Colors Unisex', NULL, NULL, 0),
(6, 1, 'T-shirt size', NULL, NULL, 0);
...
('4C876004-B96A-ADD1-51C6EE9591B71B6E', '4949043', '2018-08-14 19:51:52', 1, '4C8366EB-08-14-18', 1.27, 46.2, 3.93, 66.39415, 36, NULL, NULL, '2172 Gulf Gate drive', '', 'Sarasota', 'AL', '34231', 'USA', NULL, 0, 'Margaret Gulya', '', 0, 0),
('4E3ECF26-F26C-0D2F-DE169875B834511F', '4949043', '2018-08-14 20:39:52', 1, '4C8366EB-08-14-18', 0, 17.11, 1.45, 18.5817, 35, NULL, NULL, '2172 Gulf Gate drive', '', 'Sarasota', 'AL', '34231', 'USA', NULL, 0, 'Margaret Gulya', '', 0, 0),
('5CFD2B62-9B95-EEA0-EC3D2AE9AC429663', '4097540', '2018-12-22 08:27:22', 1, '5CF50A3D-12-22-18', 0, 78, 0, 105.9, 36, NULL, NULL, '5566 Bent Oak dr', '', 'Sarasota', 'FL', '34232', 'USA', NULL, 0, 'Margaret Gulya', '', 0, 0),
...
(58, '4C876004-B96A-ADD1-51C6EE9591B71B6E', 31, 1, 14.99, 14.99, 0, 1.27415, 0, 0, 0),
(59, '4E3ECF26-F26C-0D2F-DE169875B834511F', 59, 1, 0.02, 0.02, 0, 0.0017, 0, 0, 0),
(60, '5CFD2B62-9B95-EEA0-EC3D2AE9AC429663', 30, 2, 13.95, 27.9, 0, 0, 0, 0, 0);
...
(68, 33, 2, 'PlaceHolder_Lrg.gif', 1),
(69, 33, 1, 'PlaceHolder_Sml.gif', 1),
(70, 33, 3, 'product_expanded.gif', 1),
(71, 33, 4, 'product_small.gif', 1),
(73, 34, 2, 'PlaceHolder_Lrg.gif', 1),
(78, 36, 2, 'PlaceHolder_Lrg.gif', 1),
(79, 37, 1, 'PlaceHolder_Sml.gif', 1),
(80, 36, 1, 'PlaceHolder_Sml.gif', 1);
...
(33, '0001', 'Circle monogram', 'Venison porchetta bresaola pancetta. Swine pig ball tip capicola. T-bone jowl flank bresaola ham hock pig capicola sirloin burgdoggen tri-tip pork belly. Kevin corned beef flank chicken ball tip, tail frankfurter hamburger shank meatloaf turducken jowl pastrami.\r\n\r\nPork loin capicola pork leberkas sausage prosciutto shoulder tongue turducken sirloin alcatra. Cow shank capicola, cupim shoulder leberkas kevin pancetta tri-tip boudin. Capicola sirloin pig pancetta. Shankle chuck ball tip pig, short loin swine strip steak pork loin. Pancetta jerky sausage, shank beef ham andouille strip steak pastrami.', 'Bacon ipsum dolor amet pork pancetta porchetta, brisket ham hock ribeye drumstick chuck kevin short loin jerky pork loin beef frankfurter. Fatback jerky jowl, spare ribs meatloaf frankfurter corned beef boudin. Tri-tip biltong doner strip steak, beef jowl ball tip alcatra bacon burgdoggen pastrami buffalo.', 1, 1, 0, 0, 0),
(34, '00002', 'test combo', 'wewqeq', 'wqewqe', 2, 1, 0, 0, 0),
(36, '00007', 'test3', 'zcxvxvc', 'xcvxc', 0, 1, 0, 0, 0),
(37, '00014', 'test no sku', 'dfhdfhgd', 'xdgdfhg', 0, 1, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `tbl_skuoptions` (
  ...
  `option_FileName` varchar(100) DEFAULT NULL,
  `option_Hex` varchar(10) DEFAULT NULL,
...
INSERT INTO `tbl_skuoptions` (`option_ID`, `option_Type_ID`, `option_Name`, `option_FileName`, `option_Hex`, `option_Sort`, `option_Archive`) VALUES
(1, 1, 'Small', NULL, NULL, 1, 0),
(2, 1, 'Medium', NULL, NULL, 2, 0),
(3, 1, 'Large', NULL, NULL, 3, 0),
(4, 1, 'X-Large', NULL, NULL, 4, 0),
(5, 1, 'XX-Large', NULL, NULL, 5, 0),
(6, 2, 'Black', NULL, NULL, 1, 0),
(7, 2, 'Blue', NULL, NULL, 2, 0),
(9, 1, 'None', NULL, NULL, 9, 0),
(20, 2, 'None', NULL, NULL, 9, 0),
(21, 3, 'Fat', NULL, NULL, 1, 1),
(22, 3, 'Slim', NULL, NULL, 2, 0),
(24, 3, 'Form Fitting', NULL, NULL, 3, 0),
(25, 2, 'Green', NULL, NULL, 3, 0),
(26, 2, 'Red', NULL, NULL, 4, 0),
(27, 2, 'Mauve', NULL, NULL, 6, 0),
(28, 1, 'Boys Medium', NULL, NULL, 6, 0),
(29, 4, 'Short', NULL, NULL, 1, 0),
(30, 4, 'Long', NULL, NULL, 2, 0),
(31, 4, 'Really Long', NULL, NULL, 3, 0),
(32, 5, 'Black', NULL, '#000000', 1, 0),
(33, 5, 'Blue Jean', NULL, '#103882', 2, 0),
(34, 5, 'Boysenberry', NULL, '#6C2052', 3, 0),
(35, 5, 'Brick', NULL, '#9C5159', 4, 0),
(36, 5, 'Chalky Mint', NULL, '#95D0D5', 5, 0),
(37, 6, 'XS', NULL, NULL, 0, 0),
(38, 6, 'S', NULL, NULL, 2, 0),
(39, 6, 'M', NULL, NULL, 3, 0);
...
(30, '1sku', 22, 13.95, 10, -2, 1, 1),
(31, '2option1', 23, 14.99, 3, 4, 1, 0),
...
(57, '8', 29, 12, 0, 12, 1, 0),
(58, '9', 29, 65, 0, 9, 1, 0),
(59, 'Cheap Test Sku', 31, 0.02, 1, 996, 1, 0),
(62, '0001-black', 34, 8.99, 0, 0, 1, 1),
(63, '0001-black-med', 34, 8.99, 0, 0, 1, 2),
(64, '0001-blue-sm', 34, 8.99, 0, 0, 1, 3),
(65, '0001-blue-md', 34, 8.99, 0, 0, 1, 2),
(67, '0007-test3', 36, 9.99, 0, 0, 1, 0),
(69, '00014-nosku', 37, 1, 0, 0, 1, 0);
...
CREATE TABLE IF NOT EXISTS `tbl_templates` (
  ...
  `template_SortOrder` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_templates` (`template_ID`, `template_Name`, `template_FileName`, `template_SortOrder`) VALUES
(1, 'C3333 Comfort Colors Ladies', 'tshirtme.png', 1),
(2, 'C4017 Comfort Colors Adult Midweight', 'tshirt.png', 2);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_templatescolored`
--

CREATE TABLE IF NOT EXISTS `tbl_templatescolored` (
  `coloredtemplates_ID` int(11) NOT NULL,
  `coloredtemplates_Name` varchar(100) NOT NULL,
  `coloredtemplates_FileName` varchar(100) NOT NULL,
  `coloredtemplate_Hex` varchar(10) NOT NULL,
  `coloredtemplates_SortOrder` int(11) NOT NULL,
  `template_ID` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_templatescolored`
--

INSERT INTO `tbl_templatescolored` (`coloredtemplates_ID`, `coloredtemplates_Name`, `coloredtemplates_FileName`, `coloredtemplate_Hex`, `coloredtemplates_SortOrder`, `template_ID`) VALUES
(1, 'Black', '', '#000000', 1, 2),
(2, 'Blue Jean', '', '#103882', 2, 2),
(3, 'Boysenberry', '', '#6C2052', 3, 2),
(4, 'Brick', '', '#9C5159', 4, 2),
(5, 'Chalky Mint', '', '#95D0D5', 5, 2);
...
--
-- Indexes for table `tbl_templatescolored`
--
ALTER TABLE `tbl_templatescolored`
  ADD PRIMARY KEY (`coloredtemplates_ID`);
...
--
ALTER TABLE `tbl_adminusers`
  MODIFY `admin_UserID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_cart`
--
ALTER TABLE `tbl_cart`
  MODIFY `cart_Line_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_custstate`
  MODIFY `CustSt_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=132;
--
...
--
ALTER TABLE `tbl_list_optiontypes`
  MODIFY `optiontype_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tbl_orderskus`
  MODIFY `orderSKU_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=61;
--
...
--
ALTER TABLE `tbl_prdtcat_rel`
  MODIFY `prdt_cat_rel_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=113;
--
-- AUTO_INCREMENT for table `tbl_prdtimages`
--
ALTER TABLE `tbl_prdtimages`
  MODIFY `prdctImage_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=81;
--
-- AUTO_INCREMENT for table `tbl_prdtoption_rel`
--
ALTER TABLE `tbl_prdtoption_rel`
  MODIFY `optn_rel_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=211;
--
...
--
ALTER TABLE `tbl_prdtscndcat_rel`
  MODIFY `prdt_scnd_rel_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=236;
--
...
--
ALTER TABLE `tbl_skuoption_rel`
  MODIFY `optn_rel_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=577;
--
-- AUTO_INCREMENT for table `tbl_skus`
--
ALTER TABLE `tbl_skus`
  MODIFY `SKU_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=70;
--
...
--
-- AUTO_INCREMENT for table `tbl_templatescolored`
--
ALTER TABLE `tbl_templatescolored`
  MODIFY `coloredtemplates_ID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
