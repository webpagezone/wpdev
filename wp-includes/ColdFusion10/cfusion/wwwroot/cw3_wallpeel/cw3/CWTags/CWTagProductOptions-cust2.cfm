<cfprocessingdirective suppresswhitespace="yes">
				...
				<table>
					...
					<cfoutput query="rsSelectBuild" group="optiontype_Name">
						<tr>
							...
							<td>
								<select name="sel" id="sel#i#" onchange="cwSetDependentList(this, #i#);">
									<option value="0">
				...
				<table class="tabularData">
					...
					<cfoutput query="rsCFTable" group="SKU_MerchSKUID">
						...
						<tr class="#IIF(CurrentRow MOD 2, DE('altRowEven'), DE('altRowOdd'))#">
							...
							<cfif IsArray(Attributes.TaxRate) AND Attributes.TaxRate[1] NEQ 0>
								<td>
									#LSCurrencyFormat(decimalRound(SKU_Price*Attributes.TaxRate[2]))#
								</td>
							</cfif>
							<td align="center">
								<input name="qty#productCounter#" type="text" value="0" size="2">
								<input name="skuID#productCounter#" type="hidden" value="#rsCFTable.SKU_ID#">
							</td>
						</tr>
					</cfoutput>
				</table>
	...
	<cfif rsGetProductOptions.recordcount NEQ 0>
...
<br/>My Output
		<!--- check  5 = Tshirt Comfort --->
		<cfif rsGetProductOptions.optn_rel_OptionType_ID EQ 5>

			<!--- get all options --->
			<cfquery name="rsTshirts" datasource="#request.dsn#" username="#request.dsnusername#" password="#request.dsnpassword#">
				SELECT
				option_Archive,
				option_FileName,
				option_Hex,
			...
			<!--- <cfdump var="#rsTshirts#"> --->

					<select name="TeeColor" id="TeeColor">
                        <option value="0">
                            Choose...
                        </option>
                        <cfoutput query="rsTshirts" >
                            <option value="#option_ID#" style="background:#option_Hex#">
                                #option_Name#
                            </option>
                        </cfoutput>
                    </select>
		...
		<!--- check  6 = Tshirt Sizet --->
		<cfif rsGetProductOptions.optn_rel_OptionType_ID EQ 6>
			<!--- get all options --->
			<cfquery name="rsSize" datasource="#request.dsn#" username="#request.dsnusername#" password="#request.dsnpassword#">
				SELECT
				option_Archive,
				option_FileName,
				option_Hex,
			...
			<!--- <cfdump var="#rsSize#"> --->
			<select name="TeeSize" id="TeeSize">
                        <option value="0">
                            Choose...
                        </option>
                        <cfoutput query="rsSize" >
                            <option value="#option_ID#" >
                                #option_Name#
                            </option>
                        </cfoutput>
