...
function () {
    ...
    function O(e, t, n, r, i, s, o, u, a) {
        ...
        var k = .5 * (b + E) - N * (S - w),
            O = .5 * (w + S) + N * (E - b),
            M = Math.atan2(w - O, b - k),
            _ = Math.atan2(S - O, E - k),
            D = _ - M;
...
function () {
    ...
    function p(e, t) {
        ...
        var n = e.target || (typeof e.srcElement != "unknown" ? e.srcElement : null),
            ...
            u = 0,
            a;
        while (n && n.parentNode && !a) n = n.parentNode, n !== fabric.document && fabric.util.getElementStyle(n, "position") === "fixed" && (a = n), n !== fabric.document && s !== t && fabric.util.getElementStyle(n, "position") === "absolute" ? (o = 0, u = 0) : n === fabric.document && s !== t ? (o = r.scrollLeft || i.scrollLeft || 0, u = r.scrollTop || i.scrollTop || 0) : (o += n.scrollLeft || 0, u += n.scrollTop || 0);
        return {
            x: d(e) + o,
            y: v(e) + u
        }
...
function () {
    function e(e) {
        ...
        return r || (r = e.getAttribute("stop-color")), i || (i = e.getAttribute("stop-opacity")), r = (new fabric.Color(r)).toRgb(), {
            offset: n,
            color: r,
            opacity: i
        }
    ...
    fabric.Gradient = fabric.util.createClass({
        ...
        toLive: function (e) {
            ...
            for (var n = 0, r = this.colorStops.length; n < r; n++) {
                ...
                s && (i = (new fabric.Color(i)).setAlpha(s).toRgba()), t.addColorStop(parseFloat(o), i)
            }
            return t
        }
...
function () {
    ...
    fabric.StaticCanvas = function (e, t) {
    ...
    }, e(fabric.StaticCanvas.prototype, fabric.Observable), e(fabric.StaticCanvas.prototype, fabric.Collection), e(fabric.StaticCanvas.prototype, fabric.DataURLExporter), e(fabric.StaticCanvas.prototype, {
        backgroundColor: "",
        backgroundImage: "",
        ...
        setBackgroundImage: function (e, t, n) {
            return fabric.util.loadImage(e, function (e) {
                this.backgroundImage = e, n && "backgroundImageOpacity" in n && (this.backgroundImageOpacity = n.backgroundImageOpacity), n && "backgroundImageStretch" in
                    n && (this.backgroundImageStretch = n.backgroundImageStretch), t && t()
            }, this), this
        },
...
function () {
    ...
    fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
        ...
        createPath: function (e) {
            ...
            return t.fill = null, t.stroke = this.color, t.strokeWidth = this.width, t.strokeLineCap = this.strokeLineCap, t.strokeLineJoin = this.strokeLineJoin, t.setShadow({
        ...
        _finalizeAndAddPath: function () {
            ...
            i.set({
                left: n,
                top: r
            }), this.canvas.add(i), i.setCoords(), this.canvas.clearContext(this.canvas.contextTop), this.removeShadowStyles(), this.canvas.renderAll(), this.canvas.fire("path:created", {
                path: i
            })
        }
    })
...
function () {
    ...
    var l = {
        ...
        _setupCurrentTransform: function (e, r) {
            if (!r) return;
            var i = "drag",
                s, o = t(e, r.canvas.upperCanvasEl);
        ...
        _handleGroupLogic: function (e, t) {
            ...
            if (n) n.contains(t) ? (n.removeWithUpdate(t), this._resetObjectTransform(n), t.set("active", !1), n.size() === 1 && this.discardActiveGroup()) : (n.addWithUpdate(t), this._resetObjectTransform(n)), this.fire("selection:created", {
                ...
                if (this._activeObject && t !== this._activeObject) {
                    ...
                    this.setActiveGroup(r), n = this.getActiveGroup(), this.fire("selection:created", {
                        target: n,
                        e: e
                    })
                }
        ...
        _scaleObject: function (e, t, n) {
            ...
            var f = o.translateToOriginPoint(o.getCenterPoint(), r.originX, r.originY),
                l = o.toLocalPoint(new fabric.Point(e - i.left, t - i.top), r.originX, r.originY);
        ...
        findTarget: function (e, t) {
            ...
            for (var o = this._objects.length; o--;)
                if (this._objects[o] && this._objects[o].visible && this.containsPoint(e, this._objects[o])) {
...
function () {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        __onMouseUp: function (e) {
            ...
            if (this.isDrawingMode && this._isCurrentlyDrawing) {
                this._isCurrentlyDrawing = !1, this.freeDrawingBrush.onMouseUp(), this.fire("mouse:up", {
                    e: e
                });
                return
            }
            if (this._currentTransform) {
                var n = this._currentTransform;
                t = n.target, t._scaling && (t._scaling = !1), t.isMoving = !1, t.setCoords(), this.stateful && t.hasStateChanged() && (this.fire("object:modified", {
                    target: t
        ...
        __onMouseDown: function (e) {
            ...
            if (this.isDrawingMode) {
                t = this.getPointer(e), this._isCurrentlyDrawing = !0, this.discardActiveObject().renderAll(), this.freeDrawingBrush.onMouseDown(t), this.fire("mouse:down", {
                    e: e
                });
                return
            }
            ...
            var r = this.findTarget(e),
                i;
            t = this.getPointer(e), this._shouldClearSelection(e, r) ? (this._groupSelector = {
                    ex: t.x,
                    ey: t.y,
                    top: 0,
                    left: 0
                }, this.deactivateAllWithDispatch(), r && r.selectable &&
        ...
        __onMouseMove: function (e) {
            ...
            if (r) n = i(e, this.upperCanvasEl), r.left = n.x - this._offset.left - r.ex, r.top = n.y - this._offset.top - r.ey, this.renderTop();
                ...
                t = l.target, t.isMoving = !0, (l.action === "scale" || l.action === "scaleX" || l.action === "scaleY") && (e.altKey && (l.originX !== "center" || l.originY !== "center") || !e.altKey && l.originX === "center" && l.originY === "center") && (this._resetCurrentTransform(e), f = !0), l.action === "rotate" ? (this._rotateObject(u, a), this.fire("object:rotating", {
                    target: t,
                    e: e
                }), t.fire("rotating", {
                    e: e
                })) : l.action === "scale" ? ((e.shiftKey || this.uniScaleTransform) && !t.get("lockUniScaling") ? (l.currentAction = "scale", this._scaleObject(u, a)) : (!f && l.currentAction === "scale" && this._resetCurrentTransform(e), l.currentAction = "scaleEqually", this._scaleObject(u, a, "equally")), this.fire("object:scaling", {
                    target: t,
                    e: e
                }), t.fire("scaling", {
                    e: e
                })) : l.action === "scaleX" ? (this._scaleObject(u, a, "x"), this.fire("object:scaling", {
                    target: t,
                    e: e
                }), t.fire("scaling", {
                    e: e
                })) : l.action === "scaleY" ? (this._scaleObject(u, a, "y"), this.fire("object:scaling", {
                    target: t,
                    e: e
                }), t.fire("scaling", {
                    e: e
        ...
        _setCursorFromEvent: function (n, r) {
            ...
            if (!o) i.cursor = this.hoverCursor;
            else if (o in t) {
    ...
    __toDataURL: function (e, t) {
        ...
        var n = this.upperCanvasEl || this.lowerCanvasEl,
            r = fabric.StaticCanvas.supports("toDataURLWithQuality") ? n.toDataURL("image/" + e, t) : n.toDataURL("image/" + e);
    ...
    _enlivenObjects: function (e, t) {
        var n = this;
        e.length === 0 && t && t(), fabric.util.enlivenObjects(e, function (e) {
            e.forEach(function (e, t) {
                n.insertAt(e, t, !0)
            }), t && t()
        })
...
function (e) {
    ...
    t.Object = t.util.createClass({
        ...
        _animate: function (e, n, r, i) {
            ...
            "from" in r || (r.from = u), ~n.indexOf("=") ? n = u + parseFloat(n.replace("=", "")) : n = parseFloat(n), t.util.animate({
                startValue: r.from,
                endValue: n,
                byValue: r.by,
                easing: r.easing,
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        drawControls: function (e) {
            ...
            var t = this.cornerSize,
                n = t / 2,
                r = this.strokeWidth > 1 ? this.strokeWidth / 2 : 0,
                i = -(this.width / 2),
                s = -(this.height / 2),
                o, u, a = t / this.scaleX,
                f = t / this.scaleY,
...
function (e) {
    ...
    t.Line = t.util.createClass(t.Object, {
        ...
        _renderDashedStroke: function (e) {
            var n = this.width === 1 ? 0 : -this.width / 2,
                r = this.height === 1 ? 0 : -this.height / 2;
...
function (e) {
    ...
    n.Path = n.util.createClass(n.Object, {
        ...
        _initializePath: function (e) {
            var t = "width" in e,
                ...
                r = "left" in e,
                i = "top" in e;
            !t || !n ? (s(this, this._parseDimensions()), t && (this.width = e.width), n && (this.height = e.height)) : (i || (this.top = this.height / 2), r || (this.left = this.width / 2)), this.pathOffset = this.pathOffset || this._calculatePathOffset(i || r)
        },
    ...
    }), n.Path.fromObject = function (e) {
        return new n.Path(e.path, e)
    }, n.Path.ATTRIBUTE_NAMES = n.SHARED_ATTRIBUTES.concat(["d"]), n.Path.fromElement = function (e, t) {
        var r = n.parseAttributes(e, n.Path.ATTRIBUTE_NAMES);
        return new n.Path(r.d, s(r, t))
    }
}(typeof exports != "undefined" ? exports : this),
function (e) {
    "use strict";
...
function (e) {
...
}), fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Brightness = fabric.util.createClass({
    type: "Brightness",
    initialize: function (e) {
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Convolute = fabric.util.createClass({
    type: "Convolute",
    initialize: function (e) {
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.GradientTransparency = fabric.util.createClass({
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Grayscale = fabric.util.createClass({
    type: "Grayscale",
    applyTo: function (e) {
        var t = e.getContext("2d"),
            n = t.getImageData(0, 0, e.width, e.height),
    ...
    .Grayscale.fromObject = function () {
        return new fabric.Image.filters.Grayscale
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Invert = fabric.util.createClass({
    type: "Invert",
    applyTo: function (e) {
        var t = e.getContext("2d"),
            n = t.getImageData(0, 0, e.width, e.height),
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Noise = fabric.util.createClass({
    type: "Noise",
    initialize: function (e) {
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Pixelate = fabric.util.createClass({
    type: "Pixelate",
    initialize: function (e) {
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.RemoveWhite = fabric.util.createClass({
    type: "RemoveWhite",
    initialize: function (e) {
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Sepia = fabric.util.createClass({
    type: "Sepia",
    applyTo: function (e) {
        var t = e.getContext("2d"),
            n = t.getImageData(0, 0, e.width, e.height),
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Sepia2 = fabric.util.createClass({
    type: "Sepia2",
    applyTo: function (e) {
        var t = e.getContext("2d"),
            n = t.getImageData(0, 0, e.width, e.height),
...
}, fabric.Image.filters = fabric.Image.filters || {}, fabric.Image.filters.Tint = fabric.util.createClass({
    type: "Tint",
    initialize: function (e) {
...
function (e) {
    ...
    o.push("fontFamily", "fontWeight", "fontSize", "path", "text", "textDecoration", "textShadow", "textAlign", "fontStyle", "lineHeight", "backgroundColor", "textBackgroundColor", "useNative"), t.Text = t.util.createClass(t.Object, {
        ...
        _renderTextDecoration: function (e, t) {
            ...
            var n = this.originY === "top" ? 0 : this._getTextHeight(e, t) / 2,
                r = this;
