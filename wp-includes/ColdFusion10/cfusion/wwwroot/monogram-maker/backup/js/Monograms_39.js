...
/*
    $('#textBoxA_2').keyup(function (e) {
        
        var textUpper = $('#textBoxA_2').val();
        var textUpper2 = textUpper.toUpperCase();
        if (textA_2 && textA_2.get('type') === 'text') {
            textA_2.set({
    ...
    $('#textBoxB_2').keyup(function (e) {
        //var obj = designCanvasFront.getActiveObject();
        var textLower = $('#textBoxB_2').val();
        var textLower2 = textLower.toLowerCase();
        if (textB_2 && textB_2.get('type') === 'text') {
            textB_2.set({
                //text: $('#textBoxB_2').val()
                text: textLower2
            });
...
*/
    ...
    function AddFontsToCanvas_2() {
        ...
        var textUpper = $('#textBoxA_2').val();
        textBoxAval_2 = textUpper.toUpperCase();
        var textLower = $('#textBoxB_2').val();
        textBoxBval_2 = textLower.toLowerCase();


        textA_2 = CanvasAddMonogramLetter(fontFamily_3_1_fontSize, textBoxAval_2, fontFamily_3_1_leftPx, fontFamily_3_1_toptPx, fontFamily_3_1, fontFamily_3_1_Url);
        textB_2 = CanvasAddMonogramLetter(fontFamily_3_2_fontSize, textBoxBval_2, fontFamily_3_2_leftPx, fontFamily_3_2_toptPx, fontFamily_3_2, fontFamily_3_2_Url);


        designCanvasFront.add(textA_2);
        designCanvasFront.add(textB_2);
...
function AddFontsToCanvas_2() {
   ...
   function AddFontsToCanvas_2() {
        ...
        textBoxVal_2 = $('#textBox_2').val();
        text_2 = CanvasAddMonogramLetter(fontFamily_3_1_fontSize, textBoxVal_2, fontFamily_3_1_leftPx, fontFamily_3_1_toptPx, fontFamily_3_1, fontFamily_3_1_Url);
    ...
    function AddFontsToCanvas_1() {
        ...
        //var upperC = $('#textBoxA_1').val();

        //textBoxAval_1 = $('#textBoxA_1').val();
        var textUpper = $('#textBoxA_1').val();
        textBoxAval_1 = textUpper.toUpperCase();

        textA_1 = CanvasAddMonogramLetter(fontFamily_3_1_fontSize, textBoxAval_1, fontFamily_3_1_leftPx, fontFamily_3_1_toptPx, fontFamily_3_1, fontFamily_3_1_Url);
    ...
    function GetFontInfo(style) {
        ...
        console.log('<br/> numLetters ' + numLetters + ' style ' + style);
        ...
        if (numLetters === 2) {
            ...
            if (style === '2Circle') {
                fontFamily_3_1 = 'Two Letter Circle Monogram';
                fontFamily_3_1_Url = 'url("fonts/Two Letter Circle Monogram.ttf")';
                fontFamily_3_1_fontSize = 300;
                fontFamily_3_1_leftPx = 240;
                fontFamily_3_1_toptPx = 240;

                fontFamily_3_2 = 'Two Letter Circle Monogram';
                fontFamily_3_2_Url = 'url("fonts/Two Letter Circle Monogram.ttf")';
                fontFamily_3_2_fontSize = 300;
                fontFamily_3_2_leftPx = 350;
                fontFamily_3_2_toptPx = 240;
            }
        }
        if (numLetters === 1) {
            ...
            if (style === 'FISHTAIL') {
                fontFamily_3_1 = 'FISHTAIL FONT';
                fontFamily_3_1_Url = 'url("fonts/FISHTAIL FONT.ttf")';
                fontFamily_3_1_fontSize = 200;
                fontFamily_3_1_leftPx = 100;
                fontFamily_3_1_toptPx = 250;
            }
        }
    ...
    /* working
     ...
     designCanvasFront.on('object:selected', onObjectSelected);
     */
    ...
    function testCircle() {
        fabric.Image.fromURL('images/dataimages/Frame-singleCircle-svg.svg', function (img) {
