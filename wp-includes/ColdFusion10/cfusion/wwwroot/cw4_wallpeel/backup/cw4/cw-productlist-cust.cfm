...
<cfmodule template="cwapp/mod/cw-mod-productpaging-cust.cfm"
...
<cfif request.cwpage.showSortLinks>
	...
	<cfelse>
		<div class="col-lg-6">
			<cfoutput>
				<form name="listingSortForm" class="form-inline listingSortForm" action="#request.cwpage.baseSortUrl#">
					<cfif listLen(application.cw.productPerPageOptions) gt 1 and not request.cwpage.showAll eq 1>
						<div class="form-group">
                            <label for="listingPerPage" class="control-label">Per Page:</label>

                                <select name="listingPerPage" class="listingSortSelect" class="form-control">
                    ...
                    <div class="form-group">
						<label for="listingSortSelect" class="control-label ">Sort By:</label>
							<select name="listingSortSelect" class="listingSortSelect" class="form-control">
