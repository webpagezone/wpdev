...
<cfparam name="attributes.prev_link_text" default="&laquo;&nbsp;">
<cfparam name="attributes.next_link_text" default="&nbsp;&raquo;">
...
<!--- number of products --->
	...
	<div class="col-sm-2">
	[ <cfoutput><strong>#attributes.total_records#</strong></cfoutput> ] Item<cfif attributes.total_records neq 1>s<cfelse>&nbsp;</cfif>
	</div>
