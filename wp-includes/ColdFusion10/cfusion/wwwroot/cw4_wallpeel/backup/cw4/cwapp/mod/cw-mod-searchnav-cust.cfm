...
<cfparam name="attributes.prepend_breadcrumb" default="<li><a href='#request.cwpage.urlResults#' class='CWlink'>Store</a></li>">
<!--- global functions --->
...
<cfswitch expression="#attributes.search_type#">
	...
	<ul class="nav navbar-nav">
			<li>
				<cfif len(trim(attributes.prepend_links))>
					<cfoutput>#trim(attributes.prepend_links)#</cfoutput>
					<cfif not right(trim(attributes.prepend_links),1) is "^">^</cfif>
				</cfif>
			</li>
			...
			<li class="dropdown">
				<cfoutput>
					<a href="#attributes.action_page#?category=#category_id#"
				 		class="dropdown-toggle" data-toggle="dropdown">
					 #category_name#<cfif attributes.show_product_count> [#categoryQuery.catprodCount#]</cfif>
			...
			<cfif attributes.show_secondary>
   					...
   					<ul class="dropdown-menu" role="menu">
						...
						<!--- #relateQuery.category_id#|#attributes.action_page#?category=#category_id#&secondary=#relateQuery.secondary_id#|#relateQuery.secondary_name#<cfif attributes.show_product_count> [#relateQuery.catprodCount#]</cfif>^
						 --->
							...
							<li>
							<cfoutput>
									<a href="#attributes.action_page#?category=#relateQuery.category_id#&secondary=#relateQuery.secondary_id#">#relateQuery.secondary_name#<cfif attributes.show_product_count> [#relateQuery.catprodCount#]</cfif></a>
							</cfoutput>
							</li>
						</cfloop>
						<li class="divider"></li>
						<li class="selected">
								<cfoutput><a href="#attributes.action_page#?category=#category_id#" >

								All #category_name#<!--- <cfif attributes.show_product_count> [#categoryQuery.catprodCount#] </cfif>--->
								</a>
								</cfoutput>
						</li>
					</ul>
				<cfelse>
					...
					<cfloop query="secondaryQuery">
						<cfoutput>
								<a href="#attributes.action_page#?category=#categoryQuery.category_id#&secondary=#secondaryQuery.secondary_id#">
								#secondaryQuery.secondary_name#<cfif attributes.show_product_count> [#secondaryQuery.catprodCount#]</cfif>
								</a>
						</cfoutput>
	...
	<cfcase value="form">
		...
		<form name="<cfoutput>#attributes.form_id#</cfoutput>" class="form-inline" role="form"
		id="<cfoutput>#attributes.form_id#</cfoutput>" method="get"
		action="<cfoutput>#attributes.action_page#</cfoutput>"
		>
			<!--- keywords --->
			<cfif attributes.form_keywords>
				<input name="keywords"
				class="form-control"
				id="<cfoutput>#attributes.form_id#</cfoutput>-keywords"
				type="text"
				value="<cfoutput>#CWremoveEncoded(attributes.form_keywords_text)#</cfoutput>"
				onFocus="if(this.value == defaultValue){this.value=''}"></cfif>
			<!--- category --->
			<cfif attributes.form_category>
				<select name="category" class="form-control"
				id="<cfoutput>#attributes.form_id#</cfoutput>-category">
			...
			<cfif attributes.form_secondary>
				...
				id="<cfoutput>#attributes.form_id#</cfoutput>-secondary">
			...
			</cfif><button name="" type="submit"
					class="btn btn-default" title="<cfoutput>#attributes.form_button_label#</cfoutput>"
	...
	<cfcase value="breadcrumb">
		...
		<cfif request.cwpage.categoryID gt 0>
			...
			<!--- create the link --->
			<cfset catLink = '<li><a href="#catUrl#" class="CWlink" title="">#catName#</a></li>'>
		...
		<cfif request.cwpage.secondaryID gt 0>
			...
			<!--- create the link --->
			<cfset secondLink = '<li><a href="#secondUrl#" class="CWlink" title="">#secondName#</a></li>'>
		...
		<cfelse>
			...
			<cfif len(trim(attributes.all_secondaries_label)) and request.cwpage.categoryID gt 0>
				...
				<cfset secondLink = '<li><a href="#secondUrl#" class="CWlink" title="">#attributes.all_secondaries_label#</a></li>'>
			<cfelse>
				<cfset secondLink = ''>
			</cfif>
		</cfif>
		...
		<cfsavecontent variable="navMarkup">
			<cfoutput>
				<cfif len(trim(attributes.prepend_breadcrumb))>#attributes.separator##trim(attributes.prepend_breadcrumb)#</cfif>
				<cfif len(trim(catLink))>#attributes.separator##catLink#</cfif>
				<cfif len(trim(secondLink)) and attributes.show_secondary>#attributes.separator##secondLink#</cfif>
				<cfif len(trim(prodName))>#attributes.separator#&nbsp;&nbsp;#prodName#</cfif>
				<cfif len(trim(endLabel))>#attributes.separator#&nbsp;&nbsp;#endLabel#</cfif>
			</cfoutput>
		</cfsavecontent>
	...
	<!--- <ul class="breadcrumb">
        ...
        <li><a href="http://demo.opencart.com/index.php?route=product/product&amp;path=24&amp;product_id=28">HTC Touch HD</a></li>
      </ul> --->
