$(function () {
	...
	$('#previewSVG').click(function (e) {
		...
		var preview_width = $("#canvasFront").width();
		
		var preview_height = $("#canvasFront").height();
		
		//set the preview image width and height:
		$("#previewImageDiv").css('width', preview_width + 'px');
		$("#previewImageDiv").css('height', preview_height + 'px');
		$("#previewImageDiv").html('<img src="'+img+'"/>');
