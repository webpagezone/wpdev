<?php
$domain = "localhost:8500/PrintDesigner/main/orders/"; // Just repalce your domain part in URL. 
$contact_path  = "localhost:8500/PrintDesigner/main/images/contact/"; // Just repalce your domain part in URL. 
