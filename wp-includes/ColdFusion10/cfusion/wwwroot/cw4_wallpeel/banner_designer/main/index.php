...
<div id="container">  
	...
	<div class="hidden" id="logInPanel">
		<div class="username centre"></div>
		<div class="green" id="startBtn">Start Design</div>
		<div id="backBtn" class="orange">Back</div>		
	</div>	
	<div id="designAreaPanel">
		<div id="orderForm" class="hidden">
			<div id="FormContainer">
				<div class="closeIcon" id="closeForm"></div>
				...
				<textarea id="userMessage" name="userMessage" rows="5" cols="20"></textarea>
				<div class="orange infoBox">
					<div class="infoIcon iconHolder"></div>
					<p >Here we send you an email including your <strong>Design Code</strong><br>simply use it for Loading/Editing your Design.</p>
				</div>
				<div class="orange infoBox">
					<div class="paymentIcon iconHolder"></div>
					<p >We accept payments with <strong>PayPal</strong> or <strong>Bank Transfer</strong><br>more infos included in Order confirmation email.</p>
				</div>				
				<div class="elementHolder green" id="saveBtn">Save Design</div><div class="elementHolder blue" id="orderBtn">Order Design</div>
			</div>
		</div>
		<div id="panelArea">
