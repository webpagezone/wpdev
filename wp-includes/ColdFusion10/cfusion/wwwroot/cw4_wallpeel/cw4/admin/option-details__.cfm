...
<!--- <cfparam name="form.optiontype_iscolor" default="0"> --->
...
<cfif isDefined('form.newoption_name') and len(trim(form.newoption_name))>
	...
	0,
	trim(htmlEditFormat(form.newoption_hex)),
	trim(htmlEditFormat(form.newoption_texture))
	)>
	<!--- if no error returned from insert query --->
	...
	<cfif isDefined('form.optionIDlist')>
		...
		<cfloop list="#form.optionIDlist#" index="ID">
			...
			<cfelse>
				...
				'#htmlEditFormat(form["option_hex#loopct#"])#',
				'#htmlEditFormat(form["option_texture#loopct#"])#'
				)>
...
<cfparam name="form.optiontype_iscolor" default="#optionGroupQuery.optiontype_iscolor#">
						...
						<form action="<cfoutput>#request.cwpage.baseUrl#&sortby=#url.sortby#&sortdir=#url.sortdir#</cfoutput>" class="CWvalidate CWobserve" name="optionsForm" id="optionsForm" method="post">
							...
							<table class="CWinfoTable wide">
								...
								<tr>
									...
									<td>
										<label>
										    <input type="radio" name="optiontype_iscolor" id="optiontype_iscolor" value=0
										    <cfif form.optiontype_iscolor eq 0>checked</cfif>
										    >
										    No
										 </label>
										<label>
										    <input type="radio" name="optiontype_iscolor" id="optiontype_iscolor" value=1
										    <cfif form.optiontype_iscolor eq 1>checked</cfif>
										    >
										   Yes
										 </label>
										...
										<td colspan="5">
											...
											<table class="CWsort CWstripe" id="addOptionTable" style="display:none;">
												...
												<tr class="sortRow">
													...
													<th class="noSort">Color</th>
													<th class="noSort">Texture</th>
												...
												<tr>
													...
													<td><input type="text"name ="newoption_hex"id="newoption_hex" value="" size="7" maxlenght="7"></td>
													<td><input type="text"name ="newoption_texture"id="newoption_texture" value="" ></td>
											...
											<cfif optionsQuery.recordCount>
												...
												<table class="CWsort CWstripe" summary="<cfoutput>#request.cwpage.baseUrl#</cfoutput>" id="productOptionsTable">
													...
													<tr>
														...
														<td style="background:#optionsQuery.option_hex#"><input type="text"name ="option_hex#currentRow#"id="option_hex#currentRow#" value="#optionsQuery.option_hex#" size="7" maxlenght="7"></td>
														<td><input type="text"name ="option_texture#currentRow#"id="option_texture#currentRow#" value="#optionsQuery.option_texture#" ></td>
