...
<cfparam name="form.optiontype_iscolor" type="numeric" default="0">
...
<cfif isDefined('form.updateOptions')>
	...
	<cfloop list="#form.optionIDlist#" index="ID">
		...
		<cfparam name="form.optiontype_iscolor#loopct#" default=0>
		...
		<cfelse>
			...
			<!--- verify numeric iscolor --->
			<cfif NOT isNumeric(form["optiontype_iscolor#loopct#"])>
				<cfset #form["optiontype_iscolor#loopct#"]# = 0>
			</cfif>
			...
			#form["optiontype_iscolor#loopct#"]#,
								...
								<table class="CWsort CWstripe" summary="<cfoutput>#request.cwpage.baseUrl#</cfoutput>">
									...
									<tr>
										...
										<td>
											...
											<td>
												<label>
												    <input type="radio" name="optiontype_iscolor#currentRow#" id="optiontype_iscolor#currentRow#" value=0
												    <cfif optionGroupsQuery.optiontype_iscolor eq 0>checked</cfif>>
												    No
												 </label>
												<label>
												    <input type="radio" name="optiontype_iscolor#currentRow#" id="optiontype_iscolor#currentRow#" value=1
												    <cfif optionGroupsQuery.optiontype_iscolor eq 1>checked</cfif>>
												   Yes
												 </label>
